...
if(isset($_POST['submit'])){
  ...
  if($connectdb -> query($insertquery)){
    $result="<h5 class='text-success'>Message Sent</h5>";
  }
  else{
    die($connectdb -> error );
  } 
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <select class="form-control" name="cdoctor">
                                    ...
                                    <option value="Dr. Inaaya Islam, General Health">Dr. Inaaya Islam, General Health</option>
                                    <option value="Dr. Asaduzzaman Soumit, General Health">Dr. Asaduzzaman Soumit, General Health</option>
                                    <option value="Dr. Tanvir Ahmed, Cardiology">Dr. Tanvir Ahmed, Cardiology</option>
