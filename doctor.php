                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <i class="img-profile cprofile fas fa-plus-square " style="color:black;"></i>
                            </a>
                ...
                <div class="row">
                        <div class="col-lg-10">
                            <form id="appointment-form" role="form" method="post"
                                ...
                                <div class="section-title wow fadeInUp" data-wow-delay="0.4s" style="color:white">
                                    <h2>Add doctor</h2>
                                </div>

                                <div class="wow fadeInUp" data-wow-delay="0.8s " style="color:white">
                                    ...
                                    <button type="submit" class="form-control dBtn" id="submit" name="submit">Submit
                                        </button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <!-- Page Heading View Doctor-->
                    <h1 class="h3 mb-2" style="color:white">View Doctor</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive table-hover">
                                <table class="table table-bordered color" color id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Image</th>
                                            <th>Name</th>
